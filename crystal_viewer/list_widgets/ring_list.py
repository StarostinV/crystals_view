...
from ..func import CrystalRing, CustomCrystal
...
class RingWidgetItem(QTreeWidgetItem):
    ...
    def __init__(self, columns: List[ListColumn], num_of_columns: int, ring: CrystalRing, parent_item: QTreeWidgetItem):
    ...
    def on_check_changed(self, is_checked: bool):
        self.treeWidget().sigRingChecked.emit(self.key, is_checked)
...
class CrystalItem(QTreeWidgetItem):
    ...
    def _add_ring(self, ring: CrystalRing):
    ...
    def on_check_changed(self, is_checked: bool):
        self.treeWidget().sigGroupChecked.emit(self.key, is_checked)
...
class RingsListWidget(QTreeWidget):
    sigCrystalSelected = pyqtSignal(object)
    sigRingSelected = pyqtSignal(object)
    sigGroupChecked = pyqtSignal(object, bool)
    sigRingChecked = pyqtSignal(object, bool)
    ...
    def __init__(self, parent=None, check_boxes: bool = True, expand: bool = True,
        ...
        self._group_dict = CrystalItemDict()
    ...
    def add_crystal(self, crystal: CustomCrystal):
        if crystal.key not in self._group_dict:
            ...
            self.sigCrystalSelected(crystal.key)

    def remove_crystal(self, crystal: CustomCrystal):
        self.model().removeRow(self._group_dict.pop_crystal(crystal.key).row)
